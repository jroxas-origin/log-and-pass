...
app.post("/ccb-appt-no-slots", (req, res) => {
	...
	<env:Body>
		<CCBAppointmentResponse xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:ns0="http://schemas.xmlsoap.org/ws/2003/03/addressing" xmlns:ns2="http://xmlns.oracle.com/EnterpriseObjects/Core/Custom/Common/V2" xmlns:ns1="http://xmlns.oracle.com/EnterpriseObjects/Core/Custom/EBO/WorkOrder/V1" xmlns:ns4="urn:oasis:names:tc:xacml:2.0:context:schema:cd:04" xmlns:ns3="http://xmlns.oracle.com/EnterpriseServices/WorkOrder/V1" xmlns:ns6="http://xmlns.oracle.com/ccb/appointmentResponse" xmlns:ns5="urn:oasis:names:tc:xacml:2.0:policy:schema:cd:04" xmlns:ns8="http://xmlns.oracle.com/ccb/appointment" xmlns:ns7="http://xmlns.oracle.com/ccb/appointmentRequest" xmlns:woebo="http://xmlns.oracle.com/EnterpriseObjects/Core/EBO/WorkOrder/V1" xmlns:dvm="http://www.oracle.com/XSL/Transform/java/oracle.tip.dvm.LookupValue" xmlns:mhdr="http://www.oracle.com/XSL/Transform/java/oracle.tip.mediator.service.common.functions.MediatorExtnFunction" xmlns:corecom="http://xmlns.oracle.com/EnterpriseObjects/Core/Common/V2" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java" xmlns:oracle-xsl-mapper="http://www.oracle.com/xsl/mapper/schemas" xmlns:svcdoc="http://xmlns.oracle.com/Services/Documentation/V1" xmlns:ebs="http://xmlns.oracle.com/EnterpriseServices/Core/WorkOrder/V1" xmlns:socket="http://www.oracle.com/XSL/Transform/java/oracle.tip.adapter.socket.ProtocolTranslator" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns="http://xmlns.oracle.com/ccb/appointment">
            <wfmMessageNumber>9,17130</<wfmMessageNumber>
